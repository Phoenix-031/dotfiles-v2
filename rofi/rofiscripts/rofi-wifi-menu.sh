...
if [ -n "$current_connection" ]; then
    disconnect="󰤯  Disconnect from \"$current_connection\""
fi
...
elif [ "$chosen_network" = "󰤯  Disconnect from \"$current_connection\"" ]; then
    nmcli connection down id "$current_connection"
else
